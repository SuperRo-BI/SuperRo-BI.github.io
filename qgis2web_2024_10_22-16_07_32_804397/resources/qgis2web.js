...
map.getView().fit([-1338499.551251, 4333954.526401, 335364.552846, 5505521.405526], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ejericio2 UD9</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (50 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este visor es una práctica del complemento qgisweb';
            }
